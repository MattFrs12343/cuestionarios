                                ...
                                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                                    ...
                                    <div className="flex space-x-2">
                                        <button
                                            ...
                                            className="flex-1 inline-flex items-center justify-center px-4 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 text-white text-sm font-medium rounded-lg hover:from-blue-600 hover:to-indigo-700 dark:hover:from-blue-700 dark:hover:to-indigo-800 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 transition-all duration-200 shadow-sm hover:shadow"
                                        >
