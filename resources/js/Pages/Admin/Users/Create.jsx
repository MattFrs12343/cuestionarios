...
export default function CreateUser({ auth, roles, teams }) {
                        ...
                        <div className="bg-gradient-to-r from-green-500 to-emerald-600 dark:from-green-600 dark:to-emerald-700 px-6 py-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h1 className="text-2xl font-bold text-white">{t('admin.users.create')}</h1>
                                        <p className="text-green-100 text-sm mt-1">Preencha os dados para criar um novo usuário</p>
                                    </div>
                                </div>
                                <Link
                        ...
                        <div className="p-6">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex justify-end space-x-4">
                                    ...
                                    >
                                        {processing ? 'Criando...' : t('admin.users.create')}
                                    </button>
                                </div>
                            </form>
                        </div>
