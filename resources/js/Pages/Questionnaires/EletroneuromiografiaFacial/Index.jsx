...
export default function EletroneuromiografiaFacialIndex({ 
    auth, 
    ...
    const handleSearch = () => {
        ...
        router.get(route('questionnaires.eletroneuromiografia-facial.index'), params, {
            preserveState: true,
            replace: true
        });
    };
    ...
    const clearFilters = () => {
        ...
        router.get(route('questionnaires.eletroneuromiografia-facial.index'));
    };
    ...
    const deleteQuestionnaire = (questionnaire) => {
        if (confirm('Tem certeza que deseja excluir este questionário?')) {
            router.delete(route('questionnaires.eletroneuromiografia-facial.destroy', questionnaire.id));
        }
    };
    ...
    const handleExportToJPG = async (questionnaire) => {
        ...
        try {
            await exportQuestionnaireToJPG(questionnaire, 'eletroneuromiografia-facial', 'questionario_enmg_facial', questionnaire.nome);
        } catch (error) {
    ...
    return (
        ...
        >
            <Head title="Eletroneuromiografia Facial" />
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-xl dark:shadow-gray-900/50 rounded-xl transition-colors duration-200">
                        <div className="p-6">
                            ...
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
                                ...
                                {can.create && (
                                    <Link
                                        href={route('questionnaires.eletroneuromiografia-facial.create')}
                                            ...
                                            <div className="p-4">
                                                ...
                                                <div className="space-y-2 mb-4">
                                                    ...
                                                    <div className="flex items-center text-sm">
                                                        ...
                                                        <span className="text-gray-900 dark:text-gray-100">{questionnaire.rg}</span>
                                                    </div>
                                                    <div className="flex items-center text-sm">
                                                ...
                                                <div className="flex justify-center gap-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                                                    <Link
                                                        href={route('questionnaires.eletroneuromiografia-facial.show', questionnaire.id)}
                                    ...
                                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                        {questionnaires.data && questionnaires.data.length > 0 ? (
                                            questionnaires.data.map((questionnaire, index) => (
                                                <tr key={questionnaire.id} className={`hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 dark:hover:from-purple-900/10 dark:hover:to-indigo-900/10 transition-all duration-200 ${index % 2 === 0 ? 'bg-white dark:bg-gray-800' : 'bg-gray-50/50 dark:bg-gray-850'}`}>
