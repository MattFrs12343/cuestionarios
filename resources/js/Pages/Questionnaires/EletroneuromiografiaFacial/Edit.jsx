...
export default function Edit({ auth, teams, questionnaire }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        tem_dor_mandibula: questionnaire.tem_dor_mandibula || false,
        tem_dor_dentes_agua_gelada: questionnaire.tem_dor_dentes_agua_gelada || false,
        tem_espasmos_face: questionnaire.tem_espasmos_face || false,
        espasmos_face_parte: questionnaire.espasmos_face_parte || '',
        aplicou_botox: questionnaire.aplicou_botox || false,
        botox_parte_face: questionnaire.botox_parte_face || '',
        tem_implante_dentario: questionnaire.tem_implante_dentario || false,
        tem_dores_apos_implante: questionnaire.tem_dores_apos_implante || false,
        teve_paralisia_facial: questionnaire.teve_paralisia_facial || false,
        paralisia_facial_vezes: questionnaire.paralisia_facial_vezes || '',
        tem_parte_face_paralisada: questionnaire.tem_parte_face_paralisada || false,
        parte_face_paralisada_qual: questionnaire.parte_face_paralisada_qual || '',
        tem_enxaqueca: questionnaire.tem_enxaqueca || false,
        consegue_sorrir_normalmente: questionnaire.consegue_sorrir_normalmente || false,
        pode_comer_normalmente: questionnaire.pode_comer_normalmente || false,
        pode_assoviar: questionnaire.pode_assoviar || false,
        consegue_encher_bexiga: questionnaire.consegue_encher_bexiga || false,
        tem_infeccao_ouvido_repetidamente: questionnaire.tem_infeccao_ouvido_repetidamente || false,
        diabetico: questionnaire.diabetico || false,
        toma_medicamento: questionnaire.toma_medicamento || false,
    ...
    return (
        ...
        >
            <Head title="Editar Questionário - Eletroneuromiografia Facial" />
                                ...
                                <div className="mb-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-sm">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            {/* Mostrar pedido médico existente */}
                                            {questionnaire.pedido_medico && !pedidoMedicoPreview && (
                                                <div className="mb-3">
                                                    ...
                                                    />
                                                    <p className="text-xs text-gray-500 dark:text-gray-400">Selecione um novo arquivo para substituir</p>
                                                </div>
                                            )}
