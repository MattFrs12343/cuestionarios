...
export default function Edit({ auth, teams, questionnaire }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        dormencia_formigamento: questionnaire.dormencia_formigamento || false,
        dificuldade_sentir_objetos: questionnaire.dificuldade_sentir_objetos || false,
        feridas_sem_dor: questionnaire.feridas_sem_dor || false,
        diagnostico_diabetes_hanseniase: questionnaire.diagnostico_diabetes_hanseniase || false,
        cirurgia_fratura_recente: questionnaire.cirurgia_fratura_recente || false,
        medicamentos_sistema_nervoso: questionnaire.medicamentos_sistema_nervoso || false,
        pontos_pes: questionnaire.pontos_pes && questionnaire.pontos_pes.length ? questionnaire.pontos_pes : defaultFootPoints(),
        pontos_maos: questionnaire.pontos_maos && questionnaire.pontos_maos.length ? questionnaire.pontos_maos : defaultHandPoints(),
        pes_percent_acerto_d: questionnaire.pes_percent_acerto_d ?? '',
        pes_percent_acerto_e: questionnaire.pes_percent_acerto_e ?? '',
        pes_classificacao: questionnaire.pes_classificacao || '',
        maos_percent_acerto_d: questionnaire.maos_percent_acerto_d ?? '',
        maos_percent_acerto_e: questionnaire.maos_percent_acerto_e ?? '',
        maos_classificacao: questionnaire.maos_classificacao || '',
    ...
    return (
        ...
        >
            <Head title="Editar Questionário - Estesiometria" />
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-xl dark:shadow-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200">
                        <div className="bg-gradient-to-r from-red-500 to-rose-600 dark:from-red-600 dark:to-rose-700 px-6 py-4">
                            <h3 className="text-xl font-bold text-white">Editar Estesiometria — Avaliação Sensitiva</h3>
                        </div>
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                ...
                                <div className="mb-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-sm">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <div>
                                            ...
                                            <AnexosUploader type="estesiometria" id={questionnaire.id} files={data.anexos} onFilesChange={(f) => setData('anexos', f)} existing={questionnaire.attachments || []} />
                                ...
                                <div className="flex justify-end space-x-3">
                                    ...
                                    <button type="submit" disabled={processing} className="px-6 py-2 bg-gradient-to-r from-red-500 to-rose-600 dark:from-red-600 dark:to-rose-700 text-white rounded-lg hover:from-red-600 hover:to-rose-700 dark:hover:from-red-700 dark:hover:to-rose-800 transition-colors duration-200 disabled:opacity-50">{processing ? 'Salvando...' : 'Salvar Alterações'}</button>
                                </div>
                            </form>
                        </div>
                    </div>
