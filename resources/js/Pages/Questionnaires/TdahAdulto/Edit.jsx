...
export default function Edit({ auth, teams, questionnaire }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        parte_a_respostas: questionnaire.parte_a_respostas && questionnaire.parte_a_respostas.length === 9 ? questionnaire.parte_a_respostas : Array(9).fill(null),
        parte_a_total: questionnaire.parte_a_total ?? '',
        parte_b_respostas: questionnaire.parte_b_respostas && questionnaire.parte_b_respostas.length === 9 ? questionnaire.parte_b_respostas : Array(9).fill(null),
        parte_b_total: questionnaire.parte_b_total ?? '',
    ...
    return (
        ...
        >
            <Head title="Editar Questionário - TDAH Adulto" />
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-xl dark:shadow-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200">
                        <div className="bg-gradient-to-r from-indigo-500 to-blue-600 dark:from-indigo-600 dark:to-blue-700 px-6 py-4">
                            <h3 className="text-xl font-bold text-white">Editar ASRS-18 — TDAH Adulto</h3>
                        </div>
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                ...
                                <div className="mb-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-sm">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <AnexosUploader type="tdah-adulto" id={questionnaire.id} files={data.anexos} onFilesChange={(f) => setData('anexos', f)} existing={questionnaire.attachments || []} />
                                ...
                                <div className="flex justify-end space-x-3">
                                    ...
                                    <button type="submit" disabled={processing} className="px-6 py-2 bg-gradient-to-r from-indigo-500 to-blue-600 dark:from-indigo-600 dark:to-blue-700 text-white rounded-lg hover:from-indigo-600 hover:to-blue-700 dark:hover:from-indigo-700 dark:hover:to-blue-800 transition-colors duration-200 disabled:opacity-50">{processing ? 'Salvando...' : 'Salvar Alterações'}</button>
                                </div>
                            </form>
                        </div>
                    </div>
