...
export default function Edit({ auth, teams, questionnaire }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        berg_sentado_sem_apoio: questionnaire.berg_sentado_sem_apoio ?? '',
        berg_pe_para_sentado: questionnaire.berg_pe_para_sentado ?? '',
        berg_transferencias: questionnaire.berg_transferencias ?? '',
        berg_pe_olhos_fechados: questionnaire.berg_pe_olhos_fechados ?? '',
        berg_pe_pes_juntos: questionnaire.berg_pe_pes_juntos ?? '',
        berg_alcance_anterior: questionnaire.berg_alcance_anterior ?? '',
        berg_pegar_objeto_chao: questionnaire.berg_pegar_objeto_chao ?? '',
        berg_olhar_para_tras: questionnaire.berg_olhar_para_tras ?? '',
        berg_girar_360: questionnaire.berg_girar_360 ?? '',
        berg_tocar_degrau: questionnaire.berg_tocar_degrau ?? '',
        berg_posicao_tandem: questionnaire.berg_posicao_tandem ?? '',
        berg_apoio_monopodal: questionnaire.berg_apoio_monopodal ?? '',
        berg_total: questionnaire.berg_total ?? '',
    ...
    return (
        ...
        >
            <Head title="Editar Questionário - Avaliação do Equilíbrio" />
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-xl dark:shadow-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200">
                        <div className="bg-gradient-to-r from-yellow-500 to-orange-600 dark:from-yellow-600 dark:to-orange-700 px-6 py-4">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-white">Editar Avaliação do Equilíbrio</h3>
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                ...
                                <div className="mb-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-sm">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <AnexosUploader type="equilibrio" id={questionnaire.id} files={data.anexos} onFilesChange={(f) => setData('anexos', f)} existing={questionnaire.attachments || []} />
                                ...
                                <div className="flex justify-end space-x-3">
                                    ...
                                    <button type="submit" disabled={processing} className="px-6 py-2 bg-gradient-to-r from-yellow-500 to-orange-600 dark:from-yellow-600 dark:to-orange-700 text-white rounded-lg hover:from-yellow-600 hover:to-orange-700 dark:hover:from-yellow-700 dark:hover:to-orange-800 transition-colors duration-200 disabled:opacity-50">{processing ? 'Salvando...' : 'Salvar Alterações'}</button>
                                </div>
                            </form>
                        </div>
                    </div>
