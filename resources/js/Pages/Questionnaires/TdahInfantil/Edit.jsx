...
export default function Edit({ auth, teams, questionnaire }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        parte_2_total: questionnaire.parte_2_total ?? '',
    ...
    const handleSubmit = (e) => {
        ...
        if (data.anexos.length > 0) {
            router.post(route('questionnaires.tdah-infantil.update', questionnaire.id), { ...data, _method: 'PUT' }, {
                forceFormData: true,
                preserveScroll: true,
            });
        } else {
            put(route('questionnaires.tdah-infantil.update', questionnaire.id));
        }
    };
    ...
    return (
        ...
        >
            <Head title="Editar Questionário - TDAH Infantil" />
