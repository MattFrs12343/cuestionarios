...
export default function Create({ auth, teams }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        medicacoes_uso: '',
        fisioterapia_recente: false,
        lesao_previa_atual: false,
        lesao_previa_atual_qual: '',
        dor_atual: '',
        dor_piora_com_forca: false,
        localizacao_dor: '',

        neuro_lado_afetado: '',
        neuro_espasticidade: false,
        neuro_tremor: false,
        neuro_dominancia_igual_lado_afetado: false,
        neuro_melhor_efeito_medicacao: false,

        orto_fase_aguda_lesao: false,
        orto_dor_piora_forca: false,
        orto_quickdash_score: '',
        orto_fase_tratamento: '',

        geri_quedas_ultimo_ano: false,
        geri_num_medicamentos_dia: '',
        geri_fragilidade_fried: '',
        geri_classificacao_fragilidade: '',
        geri_comprometimento_cognitivo: false,

        pedi_dominancia_nao_definida: false,
        pedi_paralisia_cerebral_sindrome: false,
        pedi_segura_objetos_normalmente: false,
        pedi_coopera_teste: false,
        pedi_idade_cronologica_vs_desenvolvimento: '',

        dormiu_bem: false,
        esforco_fisico_24h: false,
        dor_desconforto_hoje: false,
        consentimento_tcle: false,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('questionnaires.dinamometro.store'));
    };
    ...
    return (
        ...
        >
            <Head title="Novo Questionário - Dinamômetro" />
                        ...
                        <div className="flex-1 min-w-0 max-w-4xl">
                            <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-xl dark:shadow-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200">
                                <div className="bg-gradient-to-r from-violet-500 to-purple-600 dark:from-violet-600 dark:to-purple-700 px-6 py-5">
                                    <h3 className="text-2xl font-bold text-white">Prontuário — Avaliação de Força de Preensão Manual (Dinamômetro)</h3>
                                    <p className="text-base text-violet-100 mt-1">Questionário Unificado | Neurológico · Ortopédico · Geriátrico · Pediátrico</p>
                                </div>
                                ...
                                <div className="p-6 text-gray-900 dark:text-gray-100">
                                    <form onSubmit={handleSubmit} encType="multipart/form-data">
                                        ...
                                        <div id="sec-arquivos" className="scroll-mt-24 mb-10 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-sm">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div>
                                                    ...
                                                    <AnexosUploader type="dinamometro" files={data.anexos} onFilesChange={(f) => setData('anexos', f)} />
                                        ...
                                        <div className="flex justify-end space-x-3">
                                            ...
                                            <button type="submit" disabled={processing} className="px-7 py-3 text-base font-semibold bg-gradient-to-r from-violet-500 to-purple-600 dark:from-violet-600 dark:to-purple-700 text-white rounded-lg hover:from-violet-600 hover:to-purple-700 dark:hover:from-violet-700 dark:hover:to-purple-800 transition-colors duration-200 disabled:opacity-50">{processing ? 'Salvando...' : 'Salvar Questionário'}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
