...
export default function Create({ auth, teams }) {
    ...
    // Recalcular pontuação total automaticamente
    useEffect(() => {
        const scoreFields = [
            'pontuacao_visoespacial',
            'pontuacao_nomeacao',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('questionnaires.rastreio-cognitivo.store'));
    };
    ...
    return (
        ...
        >
            <Head title="Novo Questionário - Rastreio Cognitivo" />
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-xl dark:shadow-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200">
                        <div className="bg-gradient-to-r from-teal-500 to-cyan-600 dark:from-teal-600 dark:to-cyan-700 px-6 py-4">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-white">Protocolo de Rastreio Cognitivo em Consulta</h3>
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                ...
                                <div className="mb-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 shadow-sm">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <AnexosUploader type="rastreio-cognitivo" files={data.anexos} onFilesChange={(f) => setData('anexos', f)} />
                                ...
                                <div className="flex justify-end space-x-3">
                                    ...
                                    <button type="submit" disabled={processing} className="px-6 py-2 bg-gradient-to-r from-teal-500 to-cyan-600 dark:from-teal-600 dark:to-cyan-700 text-white rounded-lg hover:from-teal-600 hover:to-cyan-700 dark:hover:from-teal-700 dark:hover:to-cyan-800 transition-colors duration-200 disabled:opacity-50">{processing ? 'Salvando...' : 'Salvar Questionário'}</button>
                                </div>
                            </form>
                        </div>
                    </div>
